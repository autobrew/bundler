...
deplist="libheif libde265 x265 jasper libtool librsvg libpng freetype fontconfig pixman cairo gettext libffi pcre jpeg-turbo libtiff fribidi pango libffi little-cms2 openjpeg webp"
